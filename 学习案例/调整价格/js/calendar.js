...
var currentYear;//当前年
var currentHour;//当前小时
var currentMinute;//当前分钟
var calendarContentDiv;//日历内容DIV
var returnDateTo;//显示到哪个文本框中
var returnFormat;//返回格式
var activeSelectBoxMonth;//月份下拉列表
var activeSelectBoxYear;//年份下拉列表
var activeSelectBoxHour;//小时下拉列表
var activeSelectBoxMinute;//分钟下拉列表
var iframeObj = false;
...
{	
	...
	closeDiv.id='rightDiv';
	var img = document.createElement('IMG');
	img.src = pathToImages + 'empty.gif';
	img.onclick = empty;
...
//调用日历的入口函数
/*
	inputField:调用日历的文本框的名字
	format:日期的显示格式
	buttonObj:调用日历的对象
	displayTime:是否显示小时和分钟的DIV
*/
...
function displayCalendarSelectBox(yearInput,monthInput,dayInput,hourInput,minuteInput,buttonObj)
{
	...
	setTimeProperties();//设置时间属性
	updateYearDiv();//修改显示年的DIV
	updateMonthDiv();//修改显示月的DIV
	updateHourDiv();//修改显示小时的DIV
	updateMinuteDiv();//修改显示分钟的DIV
}
//清空，关闭日历控件，清空文本框的值
function empty(){
	closeCalendar();
