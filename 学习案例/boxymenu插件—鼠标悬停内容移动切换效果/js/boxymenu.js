                ...
                setTimeout(function () {
                    ...
                    $('.boxy-menu>li', wrapper).mouseenter(function () {
                        if (!$(this).find('.btn-pin').hasClass('pinned')) {
                            ...
                            $(this).find('.top').stop(false, false).animate({ marginTop: -h }, speed, function () { isAnimating = false; });
                        }
                    }).mouseleave(function () {
                        if (!$(this).find('.btn-pin').hasClass('pinned')) {
                            $(this).find('.btn-pin').css('display', 'none');
                            $(this).find('.top').stop(false, false).animate({ marginTop: 0 }, speed, function () { isAnimating = false; });
                        }
                    });
